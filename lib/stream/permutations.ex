defmodule OA.Stream.Permutations do
  @moduledoc """
    Offers the permutations Stream function, which generates all permutations of a list lazyly
    Source from: https://gist.github.com/tallakt/61ef5873721a28c4f7e1
  """
  defmacro __using__(_args) do
    quote do
      def permutations(list) do
        OA.Stream.Permutations.permutations(list)
      end
    end
  end
  def permutations(list) do
